...
DIAGNOSTIC_CODES = frozenset({
    ...
    "spotify_catalog_unavailable", "spotify_ambiguous", "spotify_provider_error",
    "lastfm_no_results", "lastfm_catalog_unavailable", "lastfm_low_confidence",
    "lastfm_ambiguous", "lastfm_provider_error", "lastfm_identity_mismatch",
    "lastfm_no_mbid",
    "lastfm_track_mismatch", "lastfm_no_tags", "lastfm_lookup_fallback",
    "lastfm_collaboration_lookup", "lastfm_stale_tracks",
...
def _post_dmy(date_iso: str) -> str:
    ...
    Returns '' on unparsable input so the caller can skip the write.
    """
    if not date_iso:
        return ""
    s = (date_iso or "").strip()
...
PROVIDER_FAILURE_KINDS = frozenset({
    "http_status", "timeout", "network", "malformed_response",
    "api_error", "circuit_open", "unexpected",
})
...
APPROVED_ACF_TYPES = {
    ...
    "music_listened_at": str, "lastfm_url": str, "mbid": str, "music_total_tracks": int,
